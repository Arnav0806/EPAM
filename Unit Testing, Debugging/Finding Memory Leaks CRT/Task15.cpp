...
// ==1826== Copyright (C) 2002-2024, and GNU GPL'd, by Julian Seward et al.
// ==1826== Using Valgrind-3.26.0 and LibVEX; rerun with -h for copyright info
// ==1826== Command: ./T15
// ==1826== 
// ==1826== 
// ==1826== HEAP SUMMARY:
// ==1826==     in use at exit: 0 bytes in 0 blocks
// ==1826==   total heap usage: 5 allocs, 5 frees, 73,904 bytes allocated
// ==1826== 
// ==1826== All heap blocks were freed -- no leaks are possible
// ==1826== 
// ==1826== For lists of detected and suppressed errors, rerun with: -s
